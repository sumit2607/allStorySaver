...
public class JoshActivity extends AppCompatActivity {
    ...
    public   String intiads = "int2";
    private TextView RLDownloadLayout;
    private String GameID = "4428745";
    private   String BANNER_ID = "bnr2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout layout = findViewById(R.id.bnr);
...
//    }
        ...
        RLDownloadLayout = findViewById(R.id.login_btn1);
        ...
        RLDownloadLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(UnityAds.isReady(intiads)){
                    UnityAds.show(JoshActivity.this ,  intiads);
                }
            }
        });
